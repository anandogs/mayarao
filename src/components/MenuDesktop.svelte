  ...
  <div class="menu_container">
    ...
    >
      <img
        src={productions}
        alt="Productions"
        style={`width: 25.43vw; max-width: 366.15px; ${categories.production.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
      <div
    ...
    >
      <img
        src={comedy}
        alt="Comedy"
        style={`width: 16.36vw; max-width: 235.65px; ${categories.comedy.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
      <div
        class="category_details"
    ...
    >
      <img
        src={street}
        alt="Street"
        style={`width: 14.29vw; max-width: 205.75px; ${categories.street.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
      <div
    ...
    >
      <img
        src={appliedTheatre}
        alt="Applied Theatre"
        style={`width: 31.83vw; max-width: 458.32px; ${categories.appliedTheatre.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
      <div
        class="category_details"
    ...
    >
      <img
        src={kathakali}
        alt="Kathakali"
        style={`width: 18.63vw; max-width: 268.32px; ${categories.kathakali.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
    <div
      class="category_image"
    ...
    >
      <img
        src={making}
        alt="Making"
        style={`width: 15.84vw; max-width: 228.15px; ${categories.making.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
    <div
      class="category_image"
    ...
    >
      <img
        src={teaching}
        alt="Teaching"
        style={`width: 19.83vw; max-width: 285.6px; ${categories.teaching.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
    <div
      class="category_image"
    ...
    >
      <img
        ...
        style={`width: 33.87vw; max-width: 487.67px; ${categories.digitalCreations.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
    <div
      class="category_image"
    ...
    >
      <img
        src={events}
        alt="Events"
        style={`width: 11.99vw; max-width: 172.61px; ${categories.events.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
    <div
      class="category_image"
    ...
    >
      <img
        src={about}
        alt="About"
        style={`width: 13.11vw; max-width: 188.73px; ${categories.about.hover ? "filter: brightness(0) invert(1);" : ""}`}
      />
    </div>
  </div>
</menu>
