<script lang="ts">
  ...
  let hoveredStates: hoverType = {
    productions: false,
    comedy: false,
    street: false,
    appliedTheatre: false,
    kathakali: false,
    making: false,
    teaching: false,
    digitalCreations: false,
    events: false,
    about: false,
  };

  let toggleHover = (categoryToggle:string) => {
    hoveredStates[categoryToggle] = !hoveredStates[categoryToggle]
  }
...
<menu>
  ...
  <MenuMobileItem category="street" imgWidth="118px" img={street} url={'/street-theatre'}/>
